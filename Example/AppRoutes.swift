...
public struct AppRoutes {
    ...
    public static func registerRoutes() {
        ...
        // MARK: Proxies        
        AppRoutes.sharedRouter.proxy("routingexample://presentitem3/:presenter", tag: "Views") { (route, parameters, next) in
        ...
        AppRoutes.sharedRouter.proxy("routingexample://showitem3/:presenter", tag: "Views") { (route, parameters, next) in
            guard let presenter = parameters["presenter"] where presenter == "Item2" else {
                next(nil, nil)
                return
            }
        ...
        AppRoutes.sharedRouter.proxy("/*", tag: "Logs") { route, parameters, next in
